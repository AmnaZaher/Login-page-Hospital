...
const mockStaffData: Record<string, UserProfile> = {
  ...
  '3': {
    ...
    role: 'Cardiologist',
    department: 'Cardiology Department',
    licenseId: '#MC-33412-2023',
    location: 'Clinic Wing B, Room 11',
    email: 'ali3.mohamed@host.com',
    nationalId: 'XXX-XX-5512',
    phone: '+1 (555) 223-4455',
    address: '88 Birch Street, Chicago, IL',
    gender: 'Male',
    experience: '7 Years',
    qualifications: 'MD from Cairo University',
    status: 'Active',
    lastLogin: 'Jan 12, 2024',
  ...
  '4': {
    ...
    role: 'Cardiologist',
    department: 'Cardiology Department',
    licenseId: '#MC-44521-2022',
    location: 'Clinic Wing C, Room 5',
    email: 'ali4.mohamed@host.com',
    nationalId: 'XXX-XX-6631',
    phone: '+1 (555) 334-5566',
    address: '22 Cedar Lane, Evanston, IL',
    gender: 'Male',
    experience: '9 Years',
    qualifications: 'MD from Alexandria University',
    status: 'Active',
    lastLogin: 'Jan 12, 2024',
  ...
  '5': {
    ...
    role: 'Doctor',
    department: 'Cardiology Department',
    licenseId: '#MC-55891-2024',
    location: 'Clinic Wing A, Room 7',
    email: 'Amohamed-s@host.com',
    nationalId: 'XXX-XX-7742',
    phone: '+1 (555) 445-6677',
    address: '55 Walnut Drive, Oak Park, IL',
    gender: 'Male',
    experience: '5 Years',
    qualifications: 'MD from Ain Shams University',
    status: 'Active',
    lastLogin: 'Jan 12, 2024',
